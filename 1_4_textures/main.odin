...
main :: proc() {
	...
	gl.VertexAttribPointer(0, 3, gl.FLOAT, false, size_of([8]f32), 0)
	gl.EnableVertexAttribArray(0)
	gl.VertexAttribPointer(1, 3, gl.FLOAT, false, size_of([8]f32), size_of([3]f32))
	gl.EnableVertexAttribArray(1)
	gl.VertexAttribPointer(2, 2, gl.FLOAT, false, size_of([8]f32), size_of([6]f32))
